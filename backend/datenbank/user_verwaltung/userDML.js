...
export const createBenutzer = async (benutzername, nachname, vorname, email, passwordhash, plz, ort, strasse, hausnummer, telefonnr) => {
    const sql = `
    INSERT INTO Benutzer (benutzername, nachname, vorname, email, passwordhash, plz, ort, strasse, hausnummer, telefonnr, rolle, kontostatus)
...
/* Benutzer aktualisieren (flexibel) */export const updateBenutzer = async (
